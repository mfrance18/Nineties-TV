...
namespace NinetiesTV
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Print("Genres of the 80's", Eighties(shows));
            Print("Distinct Genres", DistinctGenres(shows));
        ...
        **************************************************************************************************/
        ...
        static List<Show> ComediesByRating(List<Show> shows)
        {
            return shows.OrderByDescending(s => s.ImdbRating).Where(s => s.Genres.Contains("Comedy")).ToList();
        }
        ...
        **************************************************************************************************/
        ...
        public static List<string> Eighties(List<Show> shows)
        {
